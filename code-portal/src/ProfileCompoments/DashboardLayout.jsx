...
export function DashboardLayout({ children }) {
  ...
  const pathname = location.pathname; // replace usePathname
              ...
              {navigation.map((item) => {
                ...
                return (
                  <Link
                    key={item.name}
                    to={item.href}
                    className={`flex items-center w-full justify-start px-3 py-2 rounded-md text-sm font-medium transition-colors ${isActive
